<template>
  <div id="create">
    ...
    <el-input type="textarea" @input="descriptionInput" v-model="description" :autosize="{ minRows: 2, maxRows: 4}" placeholder="展示博客简介" maxlength="100"></el-input>
    ...
    <!-- 添加 atIndex 开关 -->
    <p>
      <label style="margin-right: 10px;">是否展示到首页</label>
